...
const useStyles = makeStyles((theme) => ({
  root: {
    display: "flex",
    backgroundColor: "rgb(255, 226, 192)",
  },
  toolbar: {
    paddingRight: 24, // keep right padding when drawer closed
    backgroundColor: "#9d1a50",
  },
  toolbarIcon: {
    display: "flex",
    alignItems: "center",
    ...
    <div className={classes.root}>
      ...
      >
        <div className={classes.toolbarIcon}>
          <Avatar className={classes.avtar}>{name.charAt(0)}</Avatar>
          <h6 style={{ fontWeight: "bold", color: "white" }}>{name}</h6>
